(function() {
  ...
  exports.createConnection = function(options, cb) {
    var stream;
  ...
  exports.ConnectionStream = ConnectionStream = (function(_super) {
    ...
    function ConnectionStream(options) {
      var host, port, tlsoptions,
        _this = this;
      if (options == null) options = {};
      port = options.port;
      host = options.host || 'localhost';
      tlsoptions = options.tlsoptions;
      this.secure = options.security === 'ssl';
      if (this.secure) {
        if (port == null) port = 993;
        this._stream = tls.connect(port, host, tlsoptions, function() {
