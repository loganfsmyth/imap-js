(function() {
  var Client, EventEmitter, constream, dateToDatetime, parser, util,
  ...
  module.exports = Client = (function(_super) {
    ...
    function Client(options) {
      ...
      this._emitBody = options != null ? options.emit : void 0;
      this._response = {};
      this._respCallbacks = {};
      this._contQueue = [];
      ...
      this._parser = parser.createParser(parser.CLIENT, this._emitBody);
      ...
      this._parser.on('body', function() {
        ...
        return console.log(util.inspect(args, false, 20, true));
      });
      connected = false;
    ...
    Client.prototype._onTagged = function(resp) {
      ...
      this._respCallbacks[t](err, this._response);
    ...
    Client.prototype.capability = cmd({
      ...
      response: function(err, resp, cb) {
        var _ref;
        return cb(err, (_ref = resp.state) != null ? _ref['CAPABILITY'] : void 0);
      }
    });
