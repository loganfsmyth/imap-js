(function() {
  ...
  module.exports = Parser = (function(_super) {
    ...
    Parser.prototype.emitEnabled = function(stat) {
      if (this.partial) {
        this._setShouldEmit = stat;
      } else {
        this._shouldEmit = stat;
      }
  ...
  body_section_data = function() {
    ...
    return function(id) {
      ...
      return function(data) {
        ...
        body_data.value = res;
        if (body_data.partial) body_data.key += "<" + body_data.partial + ">";
        return body_data;
      };
    };
  };
  ...
  msg_att = function() {
    ...
    return onres(cb, function(val) {
      var data, result, type, v, _i, _len;
      result = {};
      for (_i = 0, _len = val.length; _i < _len; _i++) {
        v = val[_i];
        type = v[0], data = v[1];
        if (type === 'BODY' && data.key) type += data.key;
        result[type] = data;
      }
      return result;
    });
  ...
  collector_emit = function(type, cb) {
    ...
    return function(d, arg, remaining) {
      ...
      if (d) {
        ...
        if (placeholder == null) placeholder = ret;
        ended = remaining === 0;
      } else {
        if (!ended) {
