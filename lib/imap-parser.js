      ...
      switch (type) {
        ...
        case ipn.IMAP_MSG_ATT:
          if (v[0] === 'BODY' && v.length > 2) {
            ...
            o.push('value');
          } else if ((_ref3 = v[0]) === 'BODY' || _ref3 === 'RFC822' || _ref3 === 'RFC822.HEADER' || _ref3 === 'RFC822.TEXT' || _ref3 === 'RFC822.SIZE' || _ref3 === 'ENVELOPE' || _ref3 === 'FLAGS' || _ref3 === 'INTERNALDATE' || _ref3 === 'UID' || _ref3 === 'BODYSTRUCTURE') {
            o = ['name', 'value'];
          }
          return this.values[this.values.length - 1].push(this.zip(o, v));
        case ipn.IMAP_BODY:
