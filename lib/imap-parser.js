(function() {
  ...
  exports.ImapParser = ImapParser = (function() {
    ...
    ImapParser.prototype.onParserDone = function(type) {
      var i, kv, o, sec, section, text_code, v, _ref2, _ref3, _step;
      v = this.values.pop();
      o = [];
      switch (type) {
        ...
        case ipn.IMAP_KEYVALUE:
          kv = {};
          for (i = 0, _ref2 = v.length, _step = 2; 0 <= _ref2 ? i < _ref2 : i > _ref2; i += _step) {
            kv[v[i]] = v[i + 1];
          }
        ...
        case ipn.IMAP_MSG_ATT:
          if (v[0] === 'BODY' && v.length > 2) {
            ...
            o.push('value');
          } else if ((_ref3 = v[0]) === 'BODY' || _ref3 === 'RFC822' || _ref3 === 'RFC822.HEADER' || _ref3 === 'RFC822.TEXT' || _ref3 === 'RFC822.SIZE' || _ref3 === 'ENVELOPE' || _ref3 === 'FLAGS' || _ref3 === 'INTERNALEDATE' || _ref3 === 'UID' || _ref3 === 'BODYSTRUCTURE') {
            o = ['name', 'value'];
          }
          return this.values[this.values.length - 1].push(this.zip(o, v));
        case ipn.IMAP_BODY:
