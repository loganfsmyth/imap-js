...
extern "C" {
  static void init (Handle<Object> target)
  {
    ...
    NODE_DEFINE_CONSTANT(target, IMAP_LIST);
    NODE_DEFINE_CONSTANT(target, IMAP_RESP_TEXT);
    NODE_DEFINE_CONSTANT(target, IMAP_MSG_ATT);
    NODE_DEFINE_CONSTANT(target, IMAP_BODY);
    NODE_DEFINE_CONSTANT(target, IMAP_ENVELOPE);
    NODE_DEFINE_CONSTANT(target, IMAP_ADDRESS);
    NODE_DEFINE_CONSTANT(target, IMAP_SECTION);
    NODE_DEFINE_CONSTANT(target, IMAP_KEYVALUE);

    NODE_DEFINE_CONSTANT(target, IMAP_COMMAND_RESPONSE);
    NODE_DEFINE_CONSTANT(target, IMAP_GREETING_RESPONSE);
    NODE_DEFINE_CONSTANT(target, IMAP_CONTINUE_RESPONSE);
    NODE_DEFINE_CONSTANT(target, IMAP_TAGGED_RESPONSE);
    NODE_DEFINE_CONSTANT(target, IMAP_UNTAGGED_RESPONSE);
